...
export default class DDropbox {
    ...
    uploadOnDropbox(options, backupFile, dbxFilename) {
        return new Promise((resolve, reject) => {
            ...
            const mode = (options.overrideTargetBackup === true) ? 'overwrite' : 'add';// {('add'|'overwrite'|'update')} // https://github.com/dropbox/dropbox-sdk-js/blob/main/lib/types.js#L2539C23-L2539C32
